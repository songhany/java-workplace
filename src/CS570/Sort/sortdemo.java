...
public class sortdemo {
	...
	public static void main(String[] args) throws NumberFormatException, IOException {
		...
		//Insertion CS570.Sort
		
		start = System.currentTimeMillis();
		insertion_sort(arr2);
		end = System.currentTimeMillis();
		System.out.println("Insertion CS570.Sort arr1 (" + n + " elements) took " + (end - start) + " milliseconds");
		...
		//Selection CS570.Sort
		start = System.currentTimeMillis();
		selection_sort(arr3);
		end = System.currentTimeMillis();
		System.out.println("Selection CS570.Sort arr2 (" + n + " elements) took " + (end - start) + " milliseconds");
		...
		//A modification of Quicksort named dual-pivot Quicksort and a modification of Merge CS570.Sort named Timesort.
		...
		*/
		...
		System.out.println("Merge CS570.Sort arr1 (" + n + " elements) took " + (end - start) + " milliseconds");
		
		//Radix CS570.Sort O(N) algorithm
