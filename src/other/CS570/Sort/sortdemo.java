...
public class sortdemo {
	...
	public static void main(String[] args) throws NumberFormatException, IOException {
		...
		//Insertion other.CS570.Sort
		
		start = System.currentTimeMillis();
		insertion_sort(arr2);
		end = System.currentTimeMillis();
		System.out.println("Insertion other.CS570.Sort arr1 (" + n + " elements) took " + (end - start) + " milliseconds");
		...
		//Selection other.CS570.Sort
		start = System.currentTimeMillis();
		selection_sort(arr3);
		end = System.currentTimeMillis();
		System.out.println("Selection other.CS570.Sort arr2 (" + n + " elements) took " + (end - start) + " milliseconds");
		...
		//A modification of Quicksort named dual-pivot Quicksort and a modification of Merge other.CS570.Sort named Timesort.
		//Both have a time complexity of O(n log n), where n is the total number of items in the array.

		/*
		Merge other.CS570.Sort :
		Worst, Average and Best Case - O(n*log(n))

		Quick other.CS570.Sort :
		Worst case - O(n^2)
		...
		*/
		...
		System.out.println("Merge other.CS570.Sort arr1 (" + n + " elements) took " + (end - start) + " milliseconds");
		
		//Radix other.CS570.Sort O(N) algorithm
